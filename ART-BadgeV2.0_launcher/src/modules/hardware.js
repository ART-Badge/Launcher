...
var ID_KEYPS_TRUE = 0x0661;
var ID_KEYPS_FALSE = 0x0662;
...
function getBatteryLevel() {
    emqlib.send(emq_battery_channel, ID_battery_msg);
    data_pool = dcmlib.Open(dcm_pool_name);
...
function onChargeChange(onChange) {
    ...
    return dcmHWOnChange(charge_func_arr, onChange, battery_dcm_name);
}
