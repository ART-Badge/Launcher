...
var ID_GAMEOVER_AUDIO = 0x0660;
var ID_GAMEWIN_AUDIO = 0x0661;
var ID_GAMEMENU_AUDIO = 0x0663;
...
/* 游戏菜单音效*/
function game_menu_audio() {
    emqlib.send(emq_beep_channel, ID_GAMEMENU_AUDIO);
    return true;
}

/* 游戏音效-gameover */
function game_over_audio() {
    emqlib.send(emq_beep_channel, ID_GAMEOVER_AUDIO);
    return true;
}

/* 游戏音效-win */
function game_win_audio() {
    emqlib.send(emq_beep_channel, ID_GAMEWIN_AUDIO);
    return true;
}
...
module.exports = {
    ...
    game_win_audio: game_win_audio,
    openBeep: openBeep,
    game_menu_audio: game_menu_audio
}